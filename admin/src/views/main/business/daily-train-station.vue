  ...
  <a-modal v-model:visible="visible" title="每日车站" @ok="handleOk"
    ...
    <a-form :model="dailyTrainStation" :label-col="{span: 4}" :wrapper-col="{ span: 20 }">
      ...
      <a-form-item label="站名">
        <station-select-view v-model="dailyTrainStation.name" width="50%"></station-select-view>
      </a-form-item>
...
export default defineComponent({
  ...
  setup() {
    ...
    watch(() => dailyTrainStation.value.inTime, () => {
      let diff = dayjs(dailyTrainStation.value.outTime, 'HH:mm:ss').
      diff(dayjs(dailyTrainStation.value.inTime,'HH:mm:ss'), 'seconds');
